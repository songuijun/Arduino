...
#define WALL_GAP_DISTANCE_HALF 240 //mm 단위
 ...
 while(flag){
  ...
  read_imu_sensor();
      ...
      */
      ...
      motor_R_control(150 - Output);
      motor_L_control(150 + Output);
