...
int read_line_sensor(void)
{
  ...
  for (i=0; i<5;i++)
  {
    line_sensor[i]= 1 - digitalRead(line_sensor_pin[i]);//흰색이면 1 검정색이면0
    sum += line_sensor[i];
    Serial.print(line_sensor[i]);  Serial.print(" ");
  }
  Serial.println("sum  "); Serial.println(sum);
  // line _sensor[0] line_sensor[1] line_sensor[2] line_sensor[3] line_sensor{4]
  //      -4      -3      -2      -1      0     1     2     3     4
...
void line_following(int line_index)
{
  switch(line_index)
  {
    case -4:  motor_R_control(-10); motor_R_control(100);
        break;
    case -3:
        break;
    case -2:
    ...
    case -1:
        break;
    case  0: motor_R_control(120); motor_L_control(100);
        break;
    case  1:
        break;
    case  2:
    ...
    case  4: 
        break;
    case -10:motor_R_control(0); motor_R_control(0);
        break;      
  }
}
